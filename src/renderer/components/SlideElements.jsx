...
export function StaticSlide({ elements, backgroundPath = null }) {
  ...
  return (
    <div ref={ref} className="relative w-full bg-black overflow-hidden rounded" style={{ aspectRatio: '16 / 9' }}>
      {backgroundPath && <img src={mediaUrl(backgroundPath)} className="absolute inset-0 w-full h-full object-cover" alt="" />}
